...
SEQUENCE_LENGTH     = 22        # fixed sequence length; must match columns in DATA_CSV
LAYERS              = 1
HEADS               = 4
DIM_HEADS           = 64
DIM_MODEL           = 256       # should equal HEADS * DIM_HEADS
DIM_MLP             = 256       # hidden dim of MLP block; typically 4 * DIM_MODEL
TOKEN_TYPES         = 4         # vocabulary size: generators + padding + any special tokens
DIM_OUTPUT          = 3         # number of output classes predicted at each position
...
ATTENTION_DIRECTION = "bidirectional"   # "bidirectional" or "causal"
