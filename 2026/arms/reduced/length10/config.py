"""
Reduced arm, sweep point L=10 - locally reduced words (no adjacent repeats), 1,536 words.
Dataset: ../build_descent_dataset.py with FIXED_LENGTH = 10.
"""
...
SEQUENCE_LENGTH     = 10        # fixed word length; must match the number of columns per row in DATA_CSV
LAYERS              = 1
HEADS               = 4
DIM_HEADS           = 64
