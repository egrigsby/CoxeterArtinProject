"""
Reduced arm, sweep point L=16 - locally reduced words (no adjacent repeats), 2,000 words.
Dataset: ../build_descent_dataset.py with FIXED_LENGTH = 16.
"""
...
SEQUENCE_LENGTH     = 16        # fixed word length; must match the number of columns per row in DATA_CSV
LAYERS              = 1
HEADS               = 4
DIM_HEADS           = 64
