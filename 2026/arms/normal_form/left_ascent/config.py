"""
Normal-form arm - per-prefix LEFT ascent sets (complement of the left descent sets).
Same words and partition as left_descent/. Dataset: build_left_ascent_nf_dataset.py.
"""
...
# LEFT-ASCENT bitmask = complement of the left-descent bitmask, padded with -1).
# Words and the 30/70 partition (train on 599 words, test on 1399) are inherited
# unchanged from "../Affine A2" (exhaustive ShortLex normal-form words of length
# 1..36, A2~); only the labels differ — rebuilt by build_left_ascent_nf_dataset.py here.
TRAIN_CSV      = "train.csv"
TEST_CSV       = "test.csv"
