"""
Normal-form arm - per-prefix RIGHT descent sets. Same words and same partition as
left_descent/; only the labels differ. Dataset: build_right_descent_dataset.py.
"""
