...
# 1. Run the script to correct the 0s to -1s
echo "Applying descent corrections..."
python fix_descents.py

# 2. Copy the corrected data to data.csv (will error out if the file is missing)
echo "Copying corrected dataset to data.csv..."
cp -v processed_descent_data.csv data.csv
