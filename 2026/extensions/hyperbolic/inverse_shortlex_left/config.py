"""
Hyperbolic (4,3,3) - per-prefix LEFT descent sets, inverse-ShortLex normal-form words.
"""
...
DATA_PATH    = _DIR
PTH_LOCATION = str(_DIR / "workspace/model.pth")
...
# 30/70 partition come from inverse_shortlex_left_descents.csv in this folder,
