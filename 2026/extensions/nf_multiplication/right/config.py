"""
Normal-form multiplication - NF(w) x s -> NF(ws). Sequence output, cross-entropy.
...
# -1 on the w prefix and padding). RIGHT multiplication: the product is the
# ShortLex normal form of w*s. Pairs are the exhaustive normal-form words of
# length 1..36 (A2~, 1998 words) x 3 generators, split 80/20 by base word
# (seed 0), identical words and partition as the sibling ../Left folder.
