"""
Build the RIGHT-descent counterpart of the "Run 1" LeftTransformer experiment.

Reads ../"Run 1"/train.csv and test.csv (exhaustive ShortLex normal-form words of
...
from the Run 1 generator (right_descent_path is the original from
...
SOURCE_DIR = "../Run 1"           # experiment whose words/partition are inherited
TRAIN_CSV  = "train.csv"
TEST_CSV   = "test.csv"
