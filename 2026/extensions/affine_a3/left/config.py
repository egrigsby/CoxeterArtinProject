"""
Affine A3~ (4 generators) - per-prefix LEFT descent sets, exhaustive normal-form words
of length <= 18 (4,254 words, 30/70). Dataset: ../build_left_descent_nf_dataset.py.
"""
...
# built and split 30/70 by build_left_descent_nf_dataset.py in this folder
# (TRAIN_FRAC = 0.3; the job script runs the build before training).
TRAIN_CSV      = "train.csv"
TEST_CSV       = "test.csv"
