"""
Affine A3~ - per-prefix LEFT descent sets, inverse-ShortLex normal-form words.
"""
...
# 30/70 partition come from affine_a3_inverse_shortlex_left_descents.csv in this folder,
