"""
Affine A3~ - per-prefix RIGHT descent sets, inverse-ShortLex normal-form words.
"""
...
# 30/70 partition come from affine_a3_inverse_shortlex_right_descents.csv in this folder,
